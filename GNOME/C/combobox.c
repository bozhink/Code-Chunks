 ...
 * the signal. In this case, if the row selected is not the first one of
 * the ComboBox, we write its value in the terminal for the user.
 */
...
static void activate (GtkApplication *app, gpointer user_data) {
     ...
     * Setting the size to -1 means to use the "natural" default size.
