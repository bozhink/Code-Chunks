...
To set a text and show it (superimposed over the bar) use set_text("some text") and set_show_text(True). If a text is not set and set_show_text(True) the text will be the percentage of the work that has been completed.
"""
