...
namespace BooCompiler.Tests
{
	...
	public class CompilerWarningsTestFixture : AbstractCompilerTestCase
	{
		...
		{
			RunCompilerTestCase(@"BCW0001-2.boo");
		}
		
		[Test]
		public void BCW0001_3()
		{
			RunCompilerTestCase(@"BCW0001-3.boo");
		}
		...
		{
			RunCompilerTestCase(@"BCW0001-5.boo");
		}
		...
		{
			RunCompilerTestCase(@"BCW0001-8.boo");
		}
		
		[Test]
		public void BCW0001_9()
		{
			RunCompilerTestCase(@"BCW0001-9.boo");
		}
