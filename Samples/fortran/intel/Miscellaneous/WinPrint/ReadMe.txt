FORPRINT example for Intel Visual Fortran

FORTRAN_WINPRINT.F90 provides a callable routine to print the contents of an open Fortran
unit to a printer.  See the comments in that file for more details.
