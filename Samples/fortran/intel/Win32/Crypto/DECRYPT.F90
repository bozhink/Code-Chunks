...
! This software Decrypt.f90 is part of the Intel Visual Fortran samples.
!
! 
...
! Decrypt is a program that demonstrates various Win32 cryptographic API routines
! by decrypting a file as encrypted by the corresponding Encrypt program in this
! workspace. It is adapted from the MSDN sample "Decrypting a file".  See the 
