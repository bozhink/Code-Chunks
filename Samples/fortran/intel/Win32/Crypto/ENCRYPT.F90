...
! This software Encrypt.f90 is part of the Intel Visual Fortran samples.
!
! 
...
! Encrypt is a program that demonstrates various Win32 cryptographic API routines
! by encrypting a file for decryption by the corresponding Decrypt program in this
! workspace. It is adapted from the MSDN sample "Encrypting a file".  See the 
! Microsoft Windows Platform SDK documentation of the CryptoAPI for more information.
!
