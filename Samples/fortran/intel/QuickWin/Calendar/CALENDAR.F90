...
! Main program for sample Calendar program
!
! Demonstrates the use of the QuickWin library, displaying a graphical
! monthly calendar for the current month.
!
! Create the project as a QuickWin application so that the proper libraries
! are linked in.
!
