...
if not exists? %palms.jpg [
	request-download/to http://www.rebol.com/view/palms.jpg %palms.jpg
]
pic: load %palms.jpg
...
view layout [
	origin 20x10
	backdrop effect [gradient 0x1 100.20.0 0.20.80]
	vh1 "52 Button Click Test"
	vtext bold "Click buttons below to test for proper effect. Each one is a bit different."
	at 20x80 guide
	button "simple"
