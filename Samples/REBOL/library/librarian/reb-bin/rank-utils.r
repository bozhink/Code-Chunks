...
;; =========================================
rank-by-relevance: func [items [block!] target [string!]
  /local
   weights-table
   target-words
   summed-weight
...
;; ===========================================
add-skimp-results: func [items  [block!] target [string!]
  /local
   target-words
   skimp-matches
   new-finds
 ...
 if all [3 = length? target-words
         find  ["is" "in" "=" ">" "<"  ">=" "<=" "<>" "contains"] target-words/2
        ]
        [ return items]    ;; It's a dialect search (author contains "Gregg")
 ...
 foreach [index weight] ["header"        50
                         "comments"      20
                         "strings"       25
                         "body"          10
                         "documentation" 35
