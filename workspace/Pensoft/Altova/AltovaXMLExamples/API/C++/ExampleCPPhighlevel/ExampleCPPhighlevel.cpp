...
#import "c:\program files (x86)\altova\AltovaXML2013\AltovaXML_COM.exe" no_namespace 
...
HRESULT xslt2call(IApplicationPtr ipAppl, BSTR infilename)
{
	...
	BSTR xslfilename = ::SysAllocString(L"C:/Program Files (x86)/Altova/AltovaXML2013/AltovaXMLExamples/CopyInputXSLT2.xsl");
    BSTR outfilename = ::SysAllocString(L"C:/Program Files (x86)/Altova/AltovaXML2013/AltovaXMLExamples/Out.xml");
...
int main(int argc, char* argv[])
{
    ...
    //BSTR infilename = ::SysAllocString(L"C:/Program Files/Altova (x86)/AltovaXML2013/AltovaXMLExamples/notWellformed.xml");
	BSTR infilename = ::SysAllocString(L"C:/Program Files (x86)/Altova/AltovaXML2013/AltovaXMLExamples/simple.xml");
