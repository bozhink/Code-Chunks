<!-- ====================================================================== -->
<!-- SMIL 2.1 Media Objects Modules ======================================= -->
<!-- file: SMIL-media.mod
     ...
     This is SMIL 2.1.
        ...
        Author:     Rob Lanphier, Jacco van Ossenbruggen, Sjoerd Mullender
        Editor for SMIL 2.1: Sjoerd Mullender, CWI
        $Revision: 1.1.2.1 $
        $Date: 2009-01-16 13:53:39 $

     This DTD module is identified by the PUBLIC and SYSTEM identifiers:

     PUBLIC "-//W3C//ELEMENTS SMIL 2.1 Media Objects//EN"
     SYSTEM "http://www.w3.org/2005/SMIL21/SMIL-media.mod"
...
<![%SMIL.MediaParam.module;[
  ...
  <!ENTITY % SMIL.paramGroup.content "(param*)">
