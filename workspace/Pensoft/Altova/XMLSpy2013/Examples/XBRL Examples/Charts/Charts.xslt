...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:dei="http://xbrl.sec.gov/dei/2012-01-31" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://fasb.org/us-gaap/attributes" xmlns:n2="http://xbrl.us/us-types/2009-01-31" xmlns:nanonull="http://www.altova.com/nanonull" xmlns:negated="http://xbrl.us/us-gaap/negated/2008-03-31" xmlns:nonnum="http://www.xbrl.org/dtr/type/non-numeric" xmlns:num="http://www.xbrl.org/dtr/type/numeric" xmlns:ref="http://www.xbrl.org/2006/ref" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:us-gaap="http://fasb.org/us-gaap/2012-01-31" xmlns:us-gaap-att="http://xbrl.us/us-gaap/attributes" xmlns:us-roles="http://fasb.org/us-roles/2012-01-31" xmlns:us-types="http://fasb.org/us-types/2012-01-31" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrldt="http://xbrl.org/2005/xbrldt" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xl="http://www.xbrl.org/2003/XLink" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:import-schema schema-location="nanonull.xsd" namespace="http://www.altova.com/nanonull"/>
 ...
 .xbrl-cell-row-title-level-10 { padding-left:2.5cm;
				...
				<body>
					...
					<img style="height:3.47in; width:6.31in; " title="Total Assets">
						...
						<xsl:variable name="altova:nodeXAxisCategories">
							<xsl:for-each select="$XBRL">
								<xsl:for-each select="altova:distinct-nodes( $altova:XBRL-xbrl-contexts/xbrli:period[ exists( xbrli:instant ) ][ year-from-date(xbrli:instant) ge 2007 ] )">
									...
									<xsl:variable name="altova:xbrl-contexts-265066752" select="$altova:XBRL-xbrl-contexts[ fn:deep-equal( xbrli:period, current() ) ]"/>
									<altova:Pos altova:sLabel="{if (xbrli:instant) then xbrli:instant else if (xbrli:startDate) then concat(xbrli:startDate, ' - ', xbrli:endDate) else if (xbrli:forever) then 'forever' else '?'}">
										<xsl:for-each select="$altova:xbrl-contexts-265066752">
						...
						<xsl:attribute name="altova:ImageDataBase64" select="altovaext:generate-chart-image( $altova:nodeChart, xs:integer($altova:nChartWidthPx), xs:integer($altova:nChartHeightPx), &apos;binarytobase64&apos;, tokenize($altova:sChartFileName, &apos;\.&apos;)[last()]  )"/>
						...
						<xsl:variable name="altova:nodeXAxisSeries">
							<xsl:for-each select="$XBRL">
								<altova:Pos altova:sLabel="Net income">
									<xsl:variable name="altova:xbrl-contexts-265066752" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
									<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:NetIncomeLoss[ some $altova:context in $altova:xbrl-contexts-265066752 satisfies @contextRef = $altova:context/@id ]">
										<xsl:variable name="altova:current-xbrl-item" select="."/>
										<xsl:variable name="altova:current-xbrl-concept" select="."/>
										<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
									</xsl:for-each>
								...
								<altova:Pos altova:sLabel="Revenues">
									<xsl:variable name="altova:xbrl-contexts-265066904" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
									<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:SalesRevenueServicesGross[ some $altova:context in $altova:xbrl-contexts-265066904 satisfies @contextRef = $altova:context/@id ]">
										<xsl:variable name="altova:current-xbrl-item" select="."/>
										<xsl:variable name="altova:current-xbrl-concept" select="."/>
										<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
									</xsl:for-each>
					...
					<img style="height:3.47in; width:6.31in; " title="Revenues and Net Income">
						...
						<xsl:variable name="altova:nodeXAxisCategories">
							<xsl:for-each select="$XBRL">
								<altova:Pos altova:sLabel="Net income">
									<xsl:variable name="altova:xbrl-contexts-265066904" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
									<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:NetIncomeLoss[ some $altova:context in $altova:xbrl-contexts-265066904 satisfies @contextRef = $altova:context/@id ]">
										<xsl:variable name="altova:current-xbrl-item" select="."/>
										<xsl:variable name="altova:current-xbrl-concept" select="."/>
										<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
									</xsl:for-each>
								...
								<altova:Pos altova:sLabel="Revenues">
									<xsl:variable name="altova:xbrl-contexts-265066752" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
									<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:SalesRevenueServicesGross[ some $altova:context in $altova:xbrl-contexts-265066752 satisfies @contextRef = $altova:context/@id ]">
										<xsl:variable name="altova:current-xbrl-item" select="."/>
										<xsl:variable name="altova:current-xbrl-concept" select="."/>
										<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
									</xsl:for-each>
					...
					<img style="height:3.47in; width:6.31in; " title="Dividends Declared per Share">
						...
						<xsl:variable name="altova:nodeXAxisSeries">
							<xsl:for-each select="$XBRL">
								<altova:Pos>
									<xsl:variable name="altova:xbrl-contexts-265066752" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
									<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:CommonStockDividendsPerShareDeclared[ some $altova:context in $altova:xbrl-contexts-265066752 satisfies @contextRef = $altova:context/@id ]">
										<xsl:variable name="altova:current-xbrl-item" select="."/>
										<xsl:variable name="altova:current-xbrl-concept" select="."/>
										<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
									</xsl:for-each>
						...
						<xsl:variable name="altova:nodeXAxisCategories">
							<xsl:for-each select="$XBRL">
								<xsl:for-each-group select="$altova:XBRL-xbrl-contexts" group-by="year-from-date(xbrli:period/xbrli:startDate)">
									...
									<xsl:variable name="altova:xbrl-contexts-265066752" select="current-group()"/>
									<xsl:for-each select="current-grouping-key()">
										<altova:Pos altova:sLabel="{.}">
											<xsl:for-each select="$altova:xbrl-contexts-265066752">
												<altova:Context altova:ContextId="{@id}"/>
											</xsl:for-each>
											<xsl:for-each-group select="$altova:xbrl-contexts-265066752" group-by="(month-from-date(xbrli:period/xbrli:startDate) + 2) idiv 3">
												<xsl:sort select="current-grouping-key()" data-type="number" order="ascending"/>
												<xsl:variable name="altova:xbrl-contexts-265066904" select="current-group()"/>
												<xsl:for-each select="current-grouping-key()">
													<altova:Pos altova:sLabel="{concat('Q', .)}">
														<xsl:for-each select="$altova:xbrl-contexts-265066904">
															<altova:Context altova:ContextId="{@id}"/>
														</xsl:for-each>
													</altova:Pos>
												</xsl:for-each>
					...
					<img style="height:3.47in; width:6.31in; " title="Dividends Paid">
						...
						<xsl:variable name="altova:nodeXAxisSeries">
							<xsl:for-each select="$XBRL">
								<altova:Pos>
									<xsl:variable name="altova:xbrl-contexts-265066752" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and fn:count( xbrli:entity/xbrli:segment/xbrldi:explicitMember) = 0 and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
									<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:PaymentsOfDividends[ some $altova:context in $altova:xbrl-contexts-265066752 satisfies @contextRef = $altova:context/@id ]">
										<xsl:variable name="altova:current-xbrl-item" select="."/>
										<xsl:variable name="altova:current-xbrl-concept" select="."/>
										<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
									</xsl:for-each>
					...
					<img style="height:3.47in; width:6.31in; " title="Revenue per Region">
							...
							<xsl:for-each select="$XBRL">
								<xsl:for-each select="altova:distinct-nodes( $altova:XBRL-xbrl-contexts/xbrli:period[ exists( xbrli:startDate ) ][ xbrli:startDate/text() eq &apos;2009-12-01&apos; and xbrli:endDate/text() eq &apos;2010-08-31&apos; ] )">
									...
									<altova:Pos>
										...
										<xsl:if test="true()">
											<xsl:variable name="altova:xbrl-contexts-265067056" select="$altova:xbrl-contexts-265066752[ some $altova:explicitMember in xbrli:entity/xbrli:segment/xbrldi:explicitMember satisfies ( fn:resolve-QName( xs:string($altova:explicitMember/@dimension), $altova:explicitMember ) eq fn:QName( &apos;http://fasb.org/us-gaap/2012-01-31&apos;, &apos;StatementOperatingActivitiesSegmentAxis&apos; ) and fn:resolve-QName( $altova:explicitMember/text(), $altova:explicitMember ) eq fn:QName( &apos;http://www.altova.com/nanonull&apos;, &apos;USA&apos; ) ) ]"/>
											<xsl:if test="exists( $altova:xbrl-contexts-265067056 )">
												<altova:Pos altova:sLabel="USA">
													<xsl:for-each select="$altova:xbrl-contexts-265067056">
														<altova:Context altova:ContextId="{@id}"/>
													</xsl:for-each>
												</altova:Pos>
											</xsl:if>
											<xsl:variable name="altova:xbrl-contexts-265067208" select="$altova:xbrl-contexts-265066752[ some $altova:explicitMember in xbrli:entity/xbrli:segment/xbrldi:explicitMember satisfies ( fn:resolve-QName( xs:string($altova:explicitMember/@dimension), $altova:explicitMember ) eq fn:QName( &apos;http://fasb.org/us-gaap/2012-01-31&apos;, &apos;StatementOperatingActivitiesSegmentAxis&apos; ) and fn:resolve-QName( $altova:explicitMember/text(), $altova:explicitMember ) eq fn:QName( &apos;http://www.altova.com/nanonull&apos;, &apos;Europe&apos; ) ) ]"/>
											<xsl:if test="exists( $altova:xbrl-contexts-265067208 )">
												<altova:Pos altova:sLabel="Europe">
													<xsl:for-each select="$altova:xbrl-contexts-265067208">
														<altova:Context altova:ContextId="{@id}"/>
													</xsl:for-each>
												</altova:Pos>
											</xsl:if>
											<xsl:variable name="altova:xbrl-contexts-265067360" select="$altova:xbrl-contexts-265066752[ some $altova:explicitMember in xbrli:entity/xbrli:segment/xbrldi:explicitMember satisfies ( fn:resolve-QName( xs:string($altova:explicitMember/@dimension), $altova:explicitMember ) eq fn:QName( &apos;http://fasb.org/us-gaap/2012-01-31&apos;, &apos;StatementOperatingActivitiesSegmentAxis&apos; ) and fn:resolve-QName( $altova:explicitMember/text(), $altova:explicitMember ) eq fn:QName( &apos;http://www.altova.com/nanonull&apos;, &apos;Asia&apos; ) ) ]"/>
											<xsl:if test="exists( $altova:xbrl-contexts-265067360 )">
												<altova:Pos altova:sLabel="Asia">
													<xsl:for-each select="$altova:xbrl-contexts-265067360">
														<altova:Context altova:ContextId="{@id}"/>
													</xsl:for-each>
												</altova:Pos>
											</xsl:if>
						...
						<xsl:variable name="altova:nodeXAxisSeries">
							<xsl:for-each select="$XBRL">
								<xsl:if test="true()">
									<altova:Pos>
										<xsl:variable name="altova:xbrl-contexts-265066904" select="$altova:XBRL-xbrl-contexts[ fn:count( xbrli:entity/xbrli:segment/xbrldi:typedMember) = 0 and not( some $altova:explicitMember in xbrli:entity/xbrli:segment/xbrldi:explicitMember satisfies ( fn:resolve-QName( xs:string($altova:explicitMember/@dimension), $altova:explicitMember ) ne fn:QName( &apos;http://fasb.org/us-gaap/2012-01-31&apos;, &apos;StatementOperatingActivitiesSegmentAxis&apos; )) ) and fn:count( xbrli:scenario/xbrldi:typedMember) = 0 and fn:count( xbrli:scenario/xbrldi:explicitMember) = 0]"/>
										<xsl:for-each select="$XBRL/xbrli:xbrl/us-gaap:SegmentReportingInformationRevenue[ some $altova:context in $altova:xbrl-contexts-265066904 satisfies @contextRef = $altova:context/@id ]">
											<xsl:variable name="altova:current-xbrl-item" select="."/>
											<xsl:variable name="altova:current-xbrl-concept" select="."/>
											<altova:Context altova:ContextId="{@contextRef}" altova:Value="{.}"/>
										</xsl:for-each>
	...
	<xsl:template name="monetaryItemType">
		<xsl:choose>
			<xsl:when test="number( . ) &gt;= 0">
				<span>
					<xsl:variable name="altova:seqContentStrings_14A00D40">
						<xsl:value-of select="format-number(number(number( . ) div 1000000), '###,##0.##')"/>
					</xsl:variable>
					<xsl:variable name="altova:sContent_14A00D40" select="string($altova:seqContentStrings_14A00D40)"/>
					<xsl:value-of select="$altova:sContent_14A00D40"/>
				</span>
			</xsl:when>
			<xsl:otherwise>
				<span>
				...
				<span>
					<xsl:variable name="altova:seqContentStrings_14A01130">
						<xsl:value-of select="format-number(number(number( . ) * -1 div 1000000), '###,##0.##')"/>
					</xsl:variable>
					<xsl:variable name="altova:sContent_14A01130" select="string($altova:seqContentStrings_14A01130)"/>
					<xsl:value-of select="$altova:sContent_14A01130"/>
				</span>
				<span>
					<xsl:text>)</xsl:text>
				</span>
	...
	<xsl:template name="monetaryItemTypeNegative">
		<xsl:choose>
			<xsl:when test="number( . ) &gt;= 0">
				...
				<span>
					<xsl:variable name="altova:seqContentStrings_14A05E30">
						<xsl:value-of select="format-number(number(number( . ) div 1000000), '###,##0.##')"/>
					</xsl:variable>
					<xsl:variable name="altova:sContent_14A05E30" select="string($altova:seqContentStrings_14A05E30)"/>
					<xsl:value-of select="$altova:sContent_14A05E30"/>
				</span>
				<span>
					<xsl:text>)</xsl:text>
				</span>
			...
			<xsl:otherwise>
				<span>
					<xsl:variable name="altova:seqContentStrings_14A04930">
						<xsl:value-of select="format-number(number(number( . ) * -1 div 1000000), '###,##0.##')"/>
					</xsl:variable>
					<xsl:variable name="altova:sContent_14A04930" select="string($altova:seqContentStrings_14A04930)"/>
					<xsl:value-of select="$altova:sContent_14A04930"/>
				</span>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template match="/">
		...
		<xsl:for-each select="$altova:DesignAfterStep1//img[@altova:ImageDataBase64]">
			<xsl:result-document href="{@src}" method="text" encoding="base64tobinary">
