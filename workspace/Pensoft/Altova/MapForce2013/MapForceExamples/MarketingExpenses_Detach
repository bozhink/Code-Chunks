				...
				<children>
					...
					<template subtype="source" match="XML">
																										...
																										<children>
																											<tgridcell>
																												...
																												<children>
																													<condition>
																														<children>
																															<conditionbranch xpath="doc-available( $sigpath )">
																																<children>
																																	<text fixtext="☒">
																													...
																													<text fixtext=" Reported data is authenticated by digital signature!">
																														<styles _xcolor="if ( doc-available( $sigpath ) ) then &apos;#00c024&apos; else &apos;#b4b4b4&apos;" font-family="Verdana" font-style="italic" font-weight="bold"/>
																													</text>
																												</children>
																											</tgridcell>
																										</children>
																											...
																											<tgridcell>
																												...
																												<children>
																													...
																													<text fixtext=" Reported data is not authenticated">
																														<styles _xcolor="if ( doc-available( $sigpath ) ) then &apos;#b4b4b4&apos; else &apos;#ff4200&apos;" font-family="Verdana" font-style="italic" font-weight="bold"/>
																													</text>
																												</children>
																											</tgridcell>
																										</children>
						...
						<variables>
							...
							<variable name="sigpath" value="concat(base-uri(),&apos;.xsig&apos;)" valuetype="xs:string"/>
						</variables>
					</template>
				</children>
			</globaltemplate>
