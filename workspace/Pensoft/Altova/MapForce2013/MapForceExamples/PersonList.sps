				...
				<children>
					<documentsection>
						...
						<watermark>
							...
							<text condition="$SV_OutputFormat = 'RTF' or $SV_OutputFormat = 'Word2007' or $SV_OutputFormat = 'PDF'" text="!!! STRICTLY CONFIDENTAL !!!" fontfamily="Verdana" fontsize="30" transparency="85"/>
						</watermark>
					</documentsection>
					<template subtype="source" match="XML">
						<children>
							<condition>
								<children>
									<conditionbranch xpath="not($SV_OutputFormat = &apos;RTF&apos; or $SV_OutputFormat = &apos;Word2007&apos; or $SV_OutputFormat = &apos;PDF&apos;)">
										<children>
											<paragraph paragraphtag="p">
												<styles text-align="center"/>
												<children>
													<text fixtext="!!! STRICTLY CONFIDENTAL !!!">
														<styles color="#a5a5a5" font-family="verdana" font-size="30pt"/>
													</text>
												</children>
											</paragraph>
										</children>
