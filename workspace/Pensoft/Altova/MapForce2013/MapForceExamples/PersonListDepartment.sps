											...
											<tgridrow>
												<children>
													<tgridcell>
														<styles border-style="none" text-align="left"/>
														<children>
															<text fixtext="ALPHABETICAL EMPLOYEE LIST">
							...
							<tgrid>
								...
								<children>
									<tgridbody-cols>
										<children>
											<tgridcol>
												<styles _xbackground-color="if ( $ShowLetter ) then &apos;#a0c0ff&apos; else &apos;white&apos;"/>
											</tgridcol>
											<tgridcol/>
											<tgridcol/>
											<tgridcol/>
									...
									<tgridheader-rows>
										<children>
											<tgridrow>
												...
												<children>
													<tgridcell>
														<styles background-color="white" border-style="none" text-align="center"/>
													</tgridcell>
													<tgridcell>
														<children>
															<text fixtext="Last"/>
													...
													<template subtype="element" match="Person">
														<children>
															<tgridrow>
																...
																<children>
																	<tgridcell>
																		<styles _xborder-style="if ( $ShowLetter ) then &apos;solid&apos; else &apos;none&apos;" text-align="center"/>
																		<children>
																			<condition>
																				<children>
																					<conditionbranch xpath="$ShowLetter">
																						<children>
																							<template subtype="uservariable" match="$FirstChar">
																								<children>
																									<content>
																										<styles color="white" font-size="14pt" font-weight="bold"/>
																									</content>
																								</children>
																								<variables/>
																							</template>
														...
														<variables>
															<variable name="FirstChar" value="substring(Last,1,1)" valuetype="&lt;auto&gt;"/>
															<variable name="ShowLetter" value="$FirstChar != substring( preceding-sibling::Person[1]/Last, 1, 1)" valuetype="&lt;auto&gt;"/>
														</variables>
													</template>
												</children>
												<variables/>
