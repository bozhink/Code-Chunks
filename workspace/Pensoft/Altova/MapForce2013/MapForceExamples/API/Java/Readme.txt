This directory contains Java examples for the MapForce API. You can test it directly from the command line using the batch file "buildAndRun.bat", or you can compile and run it from within Eclipse.
...
MapForceAPI_JavaDoc.zip	- Javadoc of the classes from the two jar files
...
-------------------------------------------------------------------------
The example starts up MapForce and performs a few operations, including opening and closing documents and code generation. When done, MapForce stays open. Please, close it manually.
...
-------------------------------------------------------------------------
Open Eclipse and use the 'Import | Existing Projects into Workspace' command to add the Eclipse project file located in the same folder as this Readme file to your workspace. The project 'RunMapForce and ' will then appear in your Package Explorer or Navigator.
