...
<doc:summary doc:public="yes" >
    ...
    <doc:description>
      ...
      into an HTML browser.  Called by 'pap_noscript.xsl' when there is an
      error generated by the script from 'pap.xsl' to load all images contained
      within &lt;figure&gt;s into a separate window.
...
-->
    ...
    <xsl:template match="figure[1]/image">
        <xsl:choose>
