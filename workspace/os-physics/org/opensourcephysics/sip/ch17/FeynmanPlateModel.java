 ...
 */
public class FeynmanPlateModel {
  QuaternionRotation toBody = new QuaternionRotation(1, 0, 0, 0);
  ...
  public void advanceTime () {
    ...
    q2 += q2dot*dt;
    q3 += q3dot*dt;
    double norm = 1/Math.sqrt(q0*q0 + q1*q1 + q2*q2 + q3*q3);                   // renormalize to eliminate drift
    q0 *= norm;
    q1 *= norm;
    q2 *= norm;
    q3 *= norm;
