 ...
 // input parameters from user
  ...
  static final int[] rule;
   ...
   static { // set rule table
    ...
    rule[LU|LD|RI] = RU|LE|RD; rule[RU|LE|RD] = LU|LD|RI;
    // three particle rules with unperturbed particle
    rule[RU|LU|LD] = LU|LE|RI; rule[LU|LE|RI] = RU|LU|LD;
    rule[RU|LU|RD] = RU|LE|RI; rule[RU|LE|RI] = RU|LU|RD;
    rule[RU|LD|RD] = LE|RD|RI; rule[LE|RD|RI] = RU|LD|RD;
    rule[LU|LD|RD] = LE|LD|RI; rule[LE|LD|RI] = LU|LD|RD;
    rule[RU|LD|RI] = LU|RD|RI; rule[LU|RD|RI] = RU|LD|RI;
    rule[LU|LE|RD] = RU|LE|LD; rule[RU|LE|LD] = LU|LE|RD;
