...
public class NetworksApp extends AbstractSimulation {
   ...
   public void doStep() {
      network.step();
      display.setMessage(network.numberOfCompletedNetworks + " completed networks "
         + network.n + " nodes in new network");
   }
   ...
   public static void main(String args[]) {
      SimulationControl control = SimulationControl.createApp(new NetworksApp());
   }
}
