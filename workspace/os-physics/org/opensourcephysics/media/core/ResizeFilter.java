...
public class ResizeFilter extends Filter {
  ...
  public JDialog getInspector() {
    ...
    widthInField.setValue(wIn);
    widthOutField.setValue(wOut);
    heightInField.setValue(hIn);
    heightOutField.setValue(hOut);
	}
    ...
    void createGUI() {
      ...
      widthOutField.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          setWidthFactor(1.0*widthOutField.getValue() / wIn);
          refresh();
      ...
      widthOutField.addFocusListener(new FocusListener() {
        ...
        public void actionPerformed(ActionEvent e) {
          setHeightFactor(1.0*heightOutField.getValue() / hIn);
          refresh();
