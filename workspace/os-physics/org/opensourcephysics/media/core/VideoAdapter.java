...
public class VideoAdapter implements Video,
  ...
  public void setEndFrameNumber(int n) {
    ...
    if (frameCount > 1) n = Math.min(frameCount - 1, n);
  ...
  public double getFrameDuration(int n) {
    ...
    if (n == frameCount - 1) return getDuration() - getFrameTime(n);
   ...
   */
  public void setTime(double millis) {/** implemented by subclasses */}
   ...
   */
  public void setStartTime(double millis) {/** implemented by subclasses */}
   ...
   */
  public void setEndTime(double millis) {/** implemented by subclasses */}
