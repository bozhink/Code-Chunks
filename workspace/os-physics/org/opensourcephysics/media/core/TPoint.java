...
public class TPoint extends Point2D.Double
  ...
  protected static VidCartesianCoordinateStringBuilder coordinateStrBuilder
      = new VidCartesianCoordinateStringBuilder();
   ...
   */
  public void draw(DrawingPanel panel, Graphics _g) {/** implemented in subclasses */}
  ...
  public void showCoordinates(VideoPanel vidPanel) {
    if (coordsVisibleInMouseBox) {
      ...
      String s = coordinateStrBuilder.getCoordinateString(
  ...
  public void addPropertyChangeListener(PropertyChangeListener listener) {
    if (support == null) support = new SwingPropertyChangeSupport(this);
   ...
   */
  public void setPositionOnLine(int xScreen, int yScreen, 
  				VideoPanel vidPanel, TPoint end1, TPoint end2) {
    ...
    double u = ((worldPt.getX() - end1.getX()) * dx
              + (worldPt.getY() - end1.getY()) * dy)
              / end1.distanceSq(end2);
    if (java.lang.Double.isNaN(u)) u = 0;
