...
public class GrayScaleFilter extends Filter {
	...
	// static constants
	public static final double WT_R_VID = 0.30;
	public static final double WT_G_VID = 0.59;
	public static final double WT_B_VID = 0.11;
	public static final double WT_FLAT = 1.0/3;
  ...
  public void setWeights(double r, double g, double b) {
    ...
    typePanel.setBorder(BorderFactory.createTitledBorder(
    				MediaRes.getString("Filter.GrayScale.Label.Type"))); //$NON-NLS-1$
    rgbPanel.setBorder(BorderFactory.createTitledBorder(
    				MediaRes.getString("Filter.GrayScale.Label.Weight"))); //$NON-NLS-1$
