  ...
  public XMLPropertyElement(XMLProperty mother, String propertyName, String propertyType, Object value) {
    ...
    if(type.equals("string")) { //$NON-NLS-1$
      ...
      while(it.hasNext()) {
        ...
        content.add(new XMLPropertyElement(this, "item", type, next)); //$NON-NLS-1$
        i++;
      }
      ...
      if(primitive&&count>XMLControlElement.compactArraySize) {
        ...
        content.add(new XMLPropertyElement(this, "array", "string", s)); //$NON-NLS-1$ //$NON-NLS-2$
      } else {
        ...
        for(int j = 0;j<length;j++) {
          ...
          content.add(new XMLPropertyElement(this, "["+j+"]", type, next)); //$NON-NLS-1$ //$NON-NLS-2$
        }
      }
    }
  }
