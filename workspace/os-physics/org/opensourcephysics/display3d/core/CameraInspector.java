...
public class CameraInspector extends JPanel implements InteractionListener {
  ...
  private java.util.AbstractList listeners = new java.util.ArrayList();
  ...
  public CameraInspector(DrawingPanel3D panel) {
    ...
    ActionListener fieldListener = new ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        updateFields();
        ActionEvent event = new ActionEvent(CameraInspector.this,ActionEvent.ACTION_PERFORMED,"FieldChange");
        for (java.util.Iterator it = listeners.iterator(); it.hasNext(); ) ((ActionListener) it.next()).actionPerformed(event);
      }
    };
    ActionListener buttonListener = new ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        ActionEvent event = new ActionEvent(CameraInspector.this,ActionEvent.ACTION_PERFORMED,"ButtonChange");
        for (java.util.Iterator it = listeners.iterator(); it.hasNext(); ) ((ActionListener) it.next()).actionPerformed(event);
      }
    };
    ...
    perspectiveRB = new JRadioButton(ToolsRes.getString("CameraInspector.Perspective"));
    ...
    planarxyRB = new JRadioButton(ToolsRes.getString("CameraInspector.PlanarXY"));
    ...
    planaryzRB = new JRadioButton(ToolsRes.getString("CameraInspector.PlanarYZ"));
    ...
    noperspectiveRB = new JRadioButton(ToolsRes.getString("CameraInspector.NoPerspective"));
    ...
    planarxzRB = new JRadioButton(ToolsRes.getString("CameraInspector.PlanarXZ"));
    ...
    focusxField = createRow(label2Panel, field2Panel, "FocusX", fieldListener);
    focusyField = createRow(label2Panel, field2Panel, "FocusY", fieldListener);
    focuszField = createRow(label2Panel, field2Panel, "FocusZ", fieldListener);
