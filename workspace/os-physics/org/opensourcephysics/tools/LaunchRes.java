...
public class LaunchRes {
   ...
   static ResourceBundle res = ResourceBundle.getBundle("org.opensourcephysics.resources.tools.launcher", locale); //$NON-NLS-1$
   ...
   public static void setLocale(Locale loc) {
      ...
      res = ResourceBundle.getBundle("org.opensourcephysics.resources.tools.launcher", locale); //$NON-NLS-1$
