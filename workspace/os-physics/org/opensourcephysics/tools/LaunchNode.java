...
public class LaunchNode extends DefaultMutableTreeNode {
  ...
  ArrayList htmlData = new ArrayList(); // list of HTML data objects
  ...
  /**
   * Gets the keywords of this node.
   *
   * @return the keywords
   */
  ...
  /**
   * Gets the course level of this node.
   *
   * @return the level
   */
  ...
  /**
   * Gets the languages for which translations exist for this node.
   *
  ...
  private static class Loader extends XMLLoader {
    ...
    public Object loadObject(XMLControl control, Object obj) {
      ...
      Level level = OSPLog.parseLevel(control.getString("log_level")); //$NON-NLS-1$
      if(level!=null) {
        node.logLevel = level;
      }
  ...
  public class HTML {
  	public String title;
  	public boolean hyperlinksEnabled = false;
  	String path;
  	URL url;
