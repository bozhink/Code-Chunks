...
public class FontSizer {
   ...
   */
	public static void setFonts(Object obj, int level) {
		...
		if (obj instanceof Container) setFontFactor((Container)obj, factor);
		else if (obj instanceof TitledBorder) setFontFactor((TitledBorder)obj, factor);
		else if (obj instanceof Component) setFontFactor((Component)obj, factor);
  }
