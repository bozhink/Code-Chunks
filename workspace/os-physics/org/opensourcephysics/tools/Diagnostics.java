...
public class Diagnostics {
  ...
  final static String NEWLINE = System.getProperty("line.separator", "\n"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    String version = System.getProperty("java.vm.version", "unknown version"); //$NON-NLS-1$ //$NON-NLS-2$
    String vendor = System.getProperty("java.vendor"); //$NON-NLS-1$
    String aboutString = ToolsRes.getString("Diagnostics.Java.About.Version") + version + NEWLINE + vendor; //$NON-NLS-1$
    ...
    if (extfile.exists()) {
        ...
        String aboutString = ToolsRes.getString("Diagnostics.QTJava.About.Version") + version; //$NON-NLS-1$
        JOptionPane.showMessageDialog(null,
                aboutString,
			...
			catch (Error err) {failed = true;}
			if (failed) {
        JOptionPane.showMessageDialog(null,
                ToolsRes.getString("Diagnostics.QTJava.Error.Message"), //$NON-NLS-1$
                ToolsRes.getString("Diagnostics.QTJava.About.Title"), //$NON-NLS-1$
      ...
      JOptionPane.showMessageDialog(null,
              ToolsRes.getString("Diagnostics.QTJava.NotFound.Message1") + " " + extdir + NEWLINE + //$NON-NLS-1$ //$NON-NLS-2$
    ...
    if (extfile.exists()) {
        ...
        String aboutString = ToolsRes.getString("Diagnostics.Java3D.About.Version") + version + NEWLINE + vendor; //$NON-NLS-1$
        JOptionPane.showMessageDialog(null,
                aboutString,
      ...
      JOptionPane.showMessageDialog(null,
              ToolsRes.getString("Diagnostics.Java3D.NotFound.Message1") + " " + extdir + NEWLINE + //$NON-NLS-1$ //$NON-NLS-2$
    ...
    if (extfile.exists()) {
        ...
        String aboutString = ToolsRes.getString("Diagnostics.JOGL.About.Version") + version; //$NON-NLS-1$
        JOptionPane.showMessageDialog(null,
                aboutString,
			...
			if (failed) {
				JOptionPane.showMessageDialog(null,
								ToolsRes.getString("Diagnostics.JOGL.Error.Message"), //$NON-NLS-1$
								ToolsRes.getString("Diagnostics.JOGL.About.Title"), //$NON-NLS-1$ 
								JOptionPane.WARNING_MESSAGE);
			}
		}
      ...
      JOptionPane.showMessageDialog(null,
              ToolsRes.getString("Diagnostics.JOGL.NotFound.Message1") + " " + extdir + NEWLINE + //$NON-NLS-1$ //$NON-NLS-2$
    ...
    if(ResourceLoader.launchJarPath!=null) {
       ...
       try {
          ...
          if(jar!=null) {
         	 String aboutString = ToolsRes.getString("Diagnostics.Jar.About.Message.JarFile") //$NON-NLS-1$ 
         	 		+" \""+XML.getName(ResourceLoader.launchJarPath)+"\". "; //$NON-NLS-1$ //$NON-NLS-2$
      ...
      JOptionPane.showMessageDialog(null,
      				ToolsRes.getString("Diagnostics.Jar.About.Message.NoJarFile"), //$NON-NLS-1$
              ToolsRes.getString("Diagnostics.Jar.About.Title"), //$NON-NLS-1$
              JOptionPane.INFORMATION_MESSAGE);
    }
	}
    ...
    JOptionPane.showMessageDialog(null,
                                  aboutString,
                                  ToolsRes.getString("Diagnostics.OS.About.Title"), //$NON-NLS-1$
                                  JOptionPane.INFORMATION_MESSAGE);		
	}
