...
public final class Integral {
   ...
   * @return the integral
   */
  public static double simpson(final Function f, final double start, final double stop,
                               final int n) throws IllegalArgumentException {
    if(n%2!=0) {
   ...
   * @return double[][]
   */
  static public double[][] fillArray(final Function f, final double start, final double stop, final double tol,
                                     final int n) {
