...
public final class SuryonoParser extends MathExpParser {
  ...
  private String funcname[] = {
    "sin", "cos", "tan", "ln", "log", "abs", "int", "frac", "asin", "acos", "atan", "sinh", "cosh", "tanh", "asinh", "acosh", "atanh", "ceil", "floor", "round", "exp", "sqr", "sqrt", "sign", "step", "random"
  };
   ...
   *
   * Added by W. Christian to make it easy to contruct a parser for with one variable.
   *
   * @param f function
   * @param v variable
   *
   ...
   * The constructor of <code>Parser</code>.
   *
   * Added by W. Christian to make it easy to contruct a parser for with two variables.
   *
   ...
   * The constructor of <code>Parser</code>.
   *
   * Added by W. Christian to make it easy to contruct a parser for with multiple variables.
   *
   * @param f the function
   * @param v variables
   */
    ...
    while(true) {
      ...
      try {
        ...
        case '_' :
          ...
          break;
        case JUMP_CODE :
          destination = code_pointer+(int) postfix_code.charAt(code_pointer++);
        ...
        default :
          if((int) code>=REF_OFFSET) {
            ...
            stack[stack_pointer-1] = builtInExtFunction((int) code-EXT_FUNC_OFFSET, stack[stack_pointer-1], stack[stack_pointer]);
            stack_pointer--;
          } else if((int) code>=FUNC_OFFSET) {
            stack[stack_pointer] = builtInFunction((int) code-FUNC_OFFSET, stack[stack_pointer]);
          } else {
            error = CODE_DAMAGED;
            return Double.NaN;
          }
