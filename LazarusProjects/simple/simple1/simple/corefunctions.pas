...
implementation
  ...
  begin
    ...
    while not eof(FP) do begin
      read(FP, Carrier);
      if (Carrier.Content = S) then begin
  ...
  begin
    ...
    while not eof(FP) do begin
      read(FP, Carrier);
      if (Carrier.Content = S) and not (Carrier.ID = 0) then begin
        Carrier.ID := 0;
        seek(FP, N);
        write(FP, Carrier);
      end;
  ...
  begin
    ...
    while not eof(FP) do begin
      read(FP, Carrier);
      if (Carrier.Content = SOld) and not (Carrier.ID = 0) then begin
        Carrier.Content := SNew;
        seek(FP, N);
        write(FP, Carrier);
      end;
      N := N + 1;
