...
begin
    MD5Print := '';
    for I := 0 to 15 do MD5Print := MD5Print + Digits[(D[I] shr 4) and $0f] + Digits[D[I] and $0f];
end;
...
begin
    I := 0;
    Result := TRUE;
    while MD5Match and (I < 16) do begin
        MD5Match := D1[I] = D2[I];
        inc(I);
    end;
end;
