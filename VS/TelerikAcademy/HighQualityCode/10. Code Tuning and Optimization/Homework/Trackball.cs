    ...
    public class Trackball
    {
        ...
        private void Track(Point currentPosition)
        {
            ...
            Vector3D axis = Vector3D.CrossProduct(
                this.previousPosition3D,
                currentPosition3D);
            double angle = Vector3D.AngleBetween(
                this.previousPosition3D,
                currentPosition3D);
        ...
        {
            double deltaY = currentPosition.Y - this.previousPosition2D.Y;
            
            double scale = Math.Exp(deltaY / 100);    // e^(yDelta/100) is fairly arbitrary.
