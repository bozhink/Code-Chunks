...
;  build: nasm -f elf -F stabs hello-nasm.asm
;  link: ld -o hello hello-nasm.o
;
; In 64-bit protected mode you can use 64-bit registers
; (e. g. rax instead of eax, rbx instead of ebx, etc...)
;  build: nasm -f elf64 -F stabs hello-nasm.asm
;  link: ld -o hello hello-nasm.o
;
section  .data                  ; section for initialized data
str:     db 'Hello world!', 0Ah ; message string with new-line char at the end (10 decimal)
str_len: equ $ - str            ; calcs length of string (bytes) by substracting this'
                                ; address ($ symbol) from the str's start address

section	.text                   ; this is the code section
global	_start                  ; _start is the entry point and needs global scope to be 'seen'
_start:                         ; by the linker - equivalent to main() in C/C++ procedure start
	...
	int	80h             ; tell kernel to perform the system call we just set up - in linux
		                ; services are requested through the kernel
