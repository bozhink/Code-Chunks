-- Arquivo fonte Tabela2.Ads
package Tabela_Para_Inteiros_2 is

	Tabela_Cheia, Tabela_Vazia : exception;
	...
	-- Dado um índice retorna o valor
	function Valor(Tab : Tabela; Indice : Intervalo)
			return Tipo;

	function Quantos(Tab : Tabela) return Integer;
