...
-- Arquivo fonte Merge2V.Ada
with Ada.Text_IO, Merge2V;
use Ada.Text_IO;
procedure Testa_Merge_Duas_Vias is
	...
	Entrada : constant String := "c:A.DAT";
	Saida   : constant String := "d:A2.DAT";
	...
	package Merge is new Merge2V(N,Key,Rec,Data,Compara,Faz_Rec,Get_Tag);
	use Merge;
