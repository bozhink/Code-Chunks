...
// Arquivo fonte ArvoreB.cpp

#include "ArvoreB2.H"

// Algoritmo 10.29 
void Arvore_B::Init_C(Elo X)
{
	int I;
...
// Algoritmo 10.31 
void Arvore_B::Divide_Filho(Elo X, int I, Elo FI)
{
	Elo FI2;
	int J;

	FI2 = (Elo) calloc(1,sizeof(No));
	if (FI2 == NULL) {
		cout << "*** Divide_Filho Memoria insuficiente\n";
		exit(1);
		} 
...
// Algoritmo 10.32 
void Arvore_B::Insere_Nao_Cheio(Elo X, char K[], int Tag)
{
	int I;
...
int Arvore_B::Consulta_Insere(Elo R, char K[], Elo *X)
{
	int J;
...
// Algoritmo 10.33 
void Arvore_B::Insere(Elo *Ra, char K[], int Tag)
{
	Elo R, S;
	int I;
...
// Algoritmo 10.34 
int Arvore_B::Consulta(Elo R, char K[])
{
	int I = 0;
...
// Algoritmo 10.35 
int Arvore_B::Remove(Elo R, char K[])
{
	int I = 0;
...
void Arvore_B::Squash_2(Elo Ra, Elo *Nova)
{
	int I;
...
// Algoritmo 10.36 
void Arvore_B::Squash()
{
	Arvore_B R;

	R.Inicializa();

	Squash_2(Raiz,&(R.Raiz));
...
// Algoritmo 10.37 
void Arvore_B::Conta(Elo R, int *Deletados, int *Ativos)
{
	int I;
