...
REM HANOI.BAS
REM
REM GAME OF HAMURABI
REM
REM AUTHOR: CORONA DATA SYSTEMS
REM DATE: 20/12/1992
REM 
REM CONVERTED TO MBASIC BY ANDRE MURTA (SEE PROGRAM INFO)
REM
REM --------------------------------------------------------
10 cls : locate 1,1 : print "HAMURABI: Game of Hamurabi - Version 1.01"
20 locate 1,2 : print "Corona Data Systems, Inc."
30 print " "
35 randomize 1
40 rem ORIGINAL HAMURABI IN IMSAI 4K BASIC
50 rem THIS VERSION REWRITTEN 12/11/77
60 rem RANDOMIZE
310 print "HAMURABI - " nonewline
320 print "WHERE YOU GOVERN THE " nonewline
321 print "ANCIENT KINGDOM OF SUMERIA."
330 print "THE OBJECT IS TO FIGURE " nonewline
331 print "OUT HOW THE GAME WORKS!!"
340 print "(IF YOU WANT TO QUIT, " nonewline
...
490 randomize 1
1010 print " "
1020 print "HAMURABI, I BEG TO REPORT " nonewline
1021 print "THAT LAST YEAR "
1040 print a3;" PEOPLE STARVED AND ";a2 nonewline
1041 print " PEOPLE CAME TO THE CITY."
1050 if j > 0 then goto 1100
1060 let a1 = a1-int(a1/2)
1070 print "THE PLAGUE KILLED " nonewline
1071 print "HALF THE PEOPLE."
1100 print "THE POPULATION IS NOW ";a1
1120 print "WE HARVESTED ";b4;" BUSHELS " nonewline
1121 print "AT ";b3;" BUSHELS PER ACRE."
1130 print "RATS DESTROYED " nonewline
1131 print b2;" BUSHELS LEAVING ";b1 nonewline
1140 print " BUSHELS IN"
1141 print "THE STOREHOUSES."
1160 print "THE CITY OWNS ";c1 nonewline
1161 print " ACRES OF LAND."
1170 let c2 = 17+int(6 * rnd(1))
1180 print "LAND IS WORTH ";c2;" BUSHELS " nonewline
1181 print "PER ACRE."
1210 print "HAMURABI . . ."
1310 print " "
1320 print "BUY HOW MANY ACRES" nonewline
1330 input i
1335 print " "
...
1400 let b1 = b1-j
1410 let c1 = c1+i
1510 print "SELL HOW MANY ACRES" nonewline
1520 input i
1525 print " "
1530 let i = (abs(i))
...
1600 let c1 = c1-i
1610 let b1 = b1+c2*i
1710 print "HOW MANY BUSHELS SHALL " nonewline
1711 print "WE DISTRIBUTE AS FOOD? " nonewline
1720 input i
1725 print " "
...
1810 let a2 = -a3/2
1820 let a3 = 0
1910 print "HOW MANY ACRES SHALL " nonewline
1911 print "WE PLANT? " nonewline
1920 input i
1925 print " "
...
2110 goto 1010
REM ***ERROR ROUTINE
9010 print "HAMURABI, THINK AGAIN - " nonewline
9011 print " YOU ONLY HAVE "
9020 print a1;" PEOPLE, ";c1;" ACRES, AND " nonewline
