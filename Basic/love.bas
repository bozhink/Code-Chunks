...
8 PRINT " "
REM
REM PRINT "BY ROBERT INDIANA AND DAVID AHL"
REM PRINT "CONVERTED TO MBASIC BY ANDRE MURTA"
REM
51 PRINT " "
...
201 P=1
202 C=C+1
203 IF C=37 THEN GOTO 999
205 PRINT " "
210 READ A
211 A1=A1+A
212 IF P=1 THEN GOTO 300
240 FOR I=1 to A
241     PRINT " " NONEWLINE
242 NEXt
243 P=1
...
301     PRINT T(I) NONEWLINE
302 NEXT
303 P=0
400 IF A1>60 THEN GOTO 200
410 GOTO 210
999 FOR I=1 to 10
1000     PRINT " " NONEWLINE
1001 NEXT
1002 END
