...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/OracleSolarisStudio-Linux-x86/libinteg2d.so

dist/Release/OracleSolarisStudio-Linux-x86/libinteg2d.so: ${OBJECTFILES}
...
${OBJECTDIR}/src/integ2d.o: src/integ2d.f 
	...
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/integ2d.o src/integ2d.f

${OBJECTDIR}/src/setriang.o: src/setriang.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/setriang.o src/setriang.f

${OBJECTDIR}/src/twodq/greatr.o: src/twodq/greatr.f 
	${MKDIR} -p ${OBJECTDIR}/src/twodq
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/twodq/greatr.o src/twodq/greatr.f

${OBJECTDIR}/src/twodq/xerrwv.o: src/twodq/xerrwv.f 
	${MKDIR} -p ${OBJECTDIR}/src/twodq
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/twodq/xerrwv.o src/twodq/xerrwv.f

${OBJECTDIR}/src/twodq/hpins.o: src/twodq/hpins.f 
	${MKDIR} -p ${OBJECTDIR}/src/twodq
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/twodq/hpins.o src/twodq/hpins.f

${OBJECTDIR}/src/twodq/basout.o: src/twodq/basout.f 
	${MKDIR} -p ${OBJECTDIR}/src/twodq
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/twodq/basout.o src/twodq/basout.f

${OBJECTDIR}/src/triangulation/triangulation.o: src/triangulation/triangulation.f 
	${MKDIR} -p ${OBJECTDIR}/src/triangulation
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/triangulation/triangulation.o src/triangulation/triangulation.f

${OBJECTDIR}/src/twodq/twodq.o: src/twodq/twodq.f 
	${MKDIR} -p ${OBJECTDIR}/src/twodq
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/twodq/twodq.o src/twodq/twodq.f

${OBJECTDIR}/src/twodq/hpdel.o: src/twodq/hpdel.f 
	${MKDIR} -p ${OBJECTDIR}/src/twodq
	$(COMPILE.f) -fast -g -w1 -KPIC  -o ${OBJECTDIR}/src/twodq/hpdel.o src/twodq/hpdel.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/OracleSolarisStudio-Linux-x86/libinteg2d.so
	${RM} *.mod
