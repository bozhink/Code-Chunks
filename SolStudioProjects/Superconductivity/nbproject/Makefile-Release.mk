...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/libsuperconductivity.a

dist/Release/GNU-Linux-x86/libsuperconductivity.a: ${OBJECTFILES}
	${MKDIR} -p dist/Release/GNU-Linux-x86
	${RM} dist/Release/GNU-Linux-x86/libsuperconductivity.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libsuperconductivity.a ${OBJECTFILES} 
	$(RANLIB) dist/Release/GNU-Linux-x86/libsuperconductivity.a
...
${OBJECTDIR}/src/fermi.o: src/fermi.f 
	...
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/fermi.o src/fermi.f
...
${OBJECTDIR}/src/tcritical.o: src/tcritical.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/tcritical.o src/tcritical.f
...
${OBJECTDIR}/src/blockdat.o: src/blockdat.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/blockdat.o src/blockdat.f

${OBJECTDIR}/_ext/1445267685/linspace.o: ../../lib/linspace.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445267685
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/_ext/1445267685/linspace.o ../../lib/linspace.f
...
${OBJECTDIR}/src/spec.o: src/spec.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/spec.o src/spec.f
