...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/OracleSolarisStudio-Linux-x86/speedtest

dist/Debug/OracleSolarisStudio-Linux-x86/speedtest: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/1445274692/speedtest.o: ../../src/speedtest.for 
	...
	$(COMPILE.f) -g -w1 -o ${OBJECTDIR}/_ext/1445274692/speedtest.o ../../src/speedtest.for
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/OracleSolarisStudio-Linux-x86/speedtest
	${RM} *.mod
