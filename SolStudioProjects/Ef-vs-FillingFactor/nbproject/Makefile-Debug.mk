...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/ef-vs-fillingfactor

dist/Debug/GNU-Linux-x86/ef-vs-fillingfactor: ${OBJECTFILES}
...
${OBJECTDIR}/effill.o: effill.f 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/effill.o effill.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/ef-vs-fillingfactor
	${RM} *.mod
