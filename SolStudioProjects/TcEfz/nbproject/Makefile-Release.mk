...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/tcefz

dist/Release/GNU-Linux-x86/tcefz: ${OBJECTFILES}
	${MKDIR} -p dist/Release/GNU-Linux-x86
	${LINK.f} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tcefz ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/src/tcef-z-main.o: src/tcef-z-main.f 
	${MKDIR} -p ${OBJECTDIR}/src
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/src/tcef-z-main.o src/tcef-z-main.f
...
${OBJECTDIR}/_ext/452446398/tcritical.o: ../Superconductivity/src/tcritical.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/_ext/452446398/tcritical.o ../Superconductivity/src/tcritical.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/tcefz
	${RM} *.mod
