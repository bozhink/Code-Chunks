...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/tcefz

dist/Debug/GNU-Linux-x86/tcefz: ${OBJECTFILES}
...
${OBJECTDIR}/src/tcef-z-main.o: src/tcef-z-main.f 
	...
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/tcef-z-main.o src/tcef-z-main.f
...
${OBJECTDIR}/_ext/452446398/tcritical.o: ../Superconductivity/src/tcritical.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -g -o ${OBJECTDIR}/_ext/452446398/tcritical.o ../Superconductivity/src/tcritical.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/tcefz
	${RM} *.mod
