...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/findesef

dist/Debug/GNU-Linux-x86/findesef: ${OBJECTFILES}
...
${OBJECTDIR}/findesef.o: findesef.f 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/findesef.o findesef.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/findesef
	${RM} *.mod
