...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/OracleSolarisStudio-Linux-x86/findtc

dist/Release/OracleSolarisStudio-Linux-x86/findtc: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/452446398/integrand.o: ../Superconductivity/src/integrand.f 
	...
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/integrand.o ../Superconductivity/src/integrand.f
...
${OBJECTDIR}/_ext/452446398/epchip.o: ../Superconductivity/src/epchip.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/epchip.o ../Superconductivity/src/epchip.f

${OBJECTDIR}/_ext/452446398/tcintegrand.o: ../Superconductivity/src/tcintegrand.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/tcintegrand.o ../Superconductivity/src/tcintegrand.f
...
${OBJECTDIR}/_ext/452446398/secant.o: ../Superconductivity/src/secant.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/secant.o ../Superconductivity/src/secant.f

${OBJECTDIR}/_ext/452446398/i1.o: ../Superconductivity/src/i1.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/i1.o ../Superconductivity/src/i1.f

${OBJECTDIR}/_ext/452446398/eigen.o: ../Superconductivity/src/eigen.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/eigen.o ../Superconductivity/src/eigen.f
...
${OBJECTDIR}/_ext/452446398/hamilt.o: ../Superconductivity/src/hamilt.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/hamilt.o ../Superconductivity/src/hamilt.f

${OBJECTDIR}/findtc.o: findtc.f 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/findtc.o findtc.f

${OBJECTDIR}/_ext/452446398/th.o: ../Superconductivity/src/th.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/th.o ../Superconductivity/src/th.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/OracleSolarisStudio-Linux-x86/findtc
	${RM} *.mod
