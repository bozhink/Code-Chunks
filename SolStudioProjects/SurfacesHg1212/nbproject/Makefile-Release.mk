...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/OracleSolarisStudio-Linux-x86/surfaceshg1212

dist/Release/OracleSolarisStudio-Linux-x86/surfaceshg1212: ${OBJECTFILES}
...
${OBJECTDIR}/surf1212.o: surf1212.f 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/surf1212.o surf1212.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/OracleSolarisStudio-Linux-x86/surfaceshg1212
	${RM} *.mod
