...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/OracleSolarisStudio-Linux-x86/tabulate-i1

dist/Release/OracleSolarisStudio-Linux-x86/tabulate-i1: ${OBJECTFILES}
...
${OBJECTDIR}/tabi1.o: tabi1.f 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/tabi1.o tabi1.f
...
${OBJECTDIR}/_ext/452446398/tcritical.o: ../Superconductivity/src/tcritical.f 
	${MKDIR} -p ${OBJECTDIR}/_ext/452446398
	$(COMPILE.f) -fast -g -w1 -o ${OBJECTDIR}/_ext/452446398/tcritical.o ../Superconductivity/src/tcritical.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/OracleSolarisStudio-Linux-x86/tabulate-i1
	${RM} *.mod
