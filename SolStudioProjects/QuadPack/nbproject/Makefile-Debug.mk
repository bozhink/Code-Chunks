...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/OracleSolarisStudio-Linux-x86/quadpack

dist/Debug/OracleSolarisStudio-Linux-x86/quadpack: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/620275321/quadpack_prb.o: ../../../lib/quadpack/quadpack_prb.f90 
	...
	$(COMPILE.f) -g -w1 -o ${OBJECTDIR}/_ext/620275321/quadpack_prb.o ../../../lib/quadpack/quadpack_prb.f90

${OBJECTDIR}/_ext/620275321/quadpack.o: ../../../lib/quadpack/quadpack.f90 
	${MKDIR} -p ${OBJECTDIR}/_ext/620275321
	$(COMPILE.f) -g -w1 -o ${OBJECTDIR}/_ext/620275321/quadpack.o ../../../lib/quadpack/quadpack.f90
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/OracleSolarisStudio-Linux-x86/quadpack
	${RM} *.mod
