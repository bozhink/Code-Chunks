...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/OracleSolarisStudio-Linux-x86/spec-h1212

dist/Debug/OracleSolarisStudio-Linux-x86/spec-h1212: ${OBJECTFILES}
...
${OBJECTDIR}/getspec.o: getspec.f 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -w1 -o ${OBJECTDIR}/getspec.o getspec.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/OracleSolarisStudio-Linux-x86/spec-h1212
	${RM} *.mod
