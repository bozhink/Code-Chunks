...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/efevanhovees

dist/Debug/GNU-Linux-x86/efevanhovees: ${OBJECTFILES}
...
${OBJECTDIR}/src/efevhes-main.o: src/efevhes-main.f 
	...
	$(COMPILE.f) -g -o ${OBJECTDIR}/src/efevhes-main.o src/efevhes-main.f
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/efevanhovees
	${RM} *.mod
