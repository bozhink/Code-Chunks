...
/**                        DISLIN.H                            **/
/**                                                            **/
/** INCLUDE file for DISLIN C routines for the interpreter Ch. **/
/**                                                            **/
/** Date     : 30.10.2009                                      **/
/** Functions: 717                                             **/
/** Version  : 9.5 D / Ch                                      **/
...
#ifdef _CH_
#pragma _fpath "/usr/local/dislin/chf"
#pragma _lpath "/usr/local/dislin"

#include <dlfcn.h>
void *_Chdislin_handle;
_Chdislin_handle = dlopen ("dislin.dl", RTLD_LAZY);
if (_Chdislin_handle == NULL)
{ fprintf (_stderr, "Error: dlopen\n");
  exit (-1);
}
void _dlclose_dislin (void)
{ dlclose (_Chdislin_handle);
}
atexit (_dlclose_dislin);
#endif
