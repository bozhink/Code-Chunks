...
//<editor-fold defaultstate="collapsed" desc=" Generated Method: commandAction for Displayables ">//GEN-BEGIN:|7-commandAction|0|7-preCommandAction
    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        // write pre-action user code here
        if (displayable == fileBrowser) {//GEN-BEGIN:|7-commandAction|1|76-preAction
            if (command == FileBrowser.SELECT_FILE_COMMAND) {//GEN-END:|7-commandAction|1|76-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm1());//GEN-LINE:|7-commandAction|2|76-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|3|34-preAction
        } else if (displayable == form1) {
            if (command == exitCommand1) {//GEN-END:|7-commandAction|3|34-preAction
                // write pre-action user code here
                exitMIDlet();//GEN-LINE:|7-commandAction|4|34-postAction
                // write post-action user code here
            } else if (command == okCommand) {//GEN-LINE:|7-commandAction|5|32-preAction
                PrintCurrentTime();
//GEN-LINE:|7-commandAction|6|32-postAction
                // write post-action user code here
            } else if (command == screenCommand) {//GEN-LINE:|7-commandAction|7|36-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm2());//GEN-LINE:|7-commandAction|8|36-postAction
                // write post-action user code here
            } else if (command == screenCommand1) {//GEN-LINE:|7-commandAction|9|57-preAction
               // saveData();
                switchDisplayable(null, getFileBrowser());//GEN-LINE:|7-commandAction|10|57-postAction
                // write post-action user code here
                String url = fileBrowser.getSelectedFileURL();
                textField.setString(url);
            }//GEN-BEGIN:|7-commandAction|11|43-preAction
        } else if (displayable == form2) {
            if (command == cancelCommand) {//GEN-END:|7-commandAction|11|43-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm1());//GEN-LINE:|7-commandAction|12|43-postAction
                // write post-action user code here
            } else if (command == okCommand1) {//GEN-LINE:|7-commandAction|13|41-preAction
                this.setResize();
...
//GEN-LINE:|7-commandAction|14|41-postAction
            ...
            if (command == SplashScreen.DISMISS_COMMAND) {//GEN-END:|7-commandAction|15|50-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm1());//GEN-LINE:|7-commandAction|16|50-postAction
                // write post-action user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: screenCommand1 ">//GEN-BEGIN:|56-getter|0|56-preInit
    ...
    public Command getScreenCommand1() {
        if (screenCommand1 == null) {//GEN-END:|56-getter|0|56-preInit
            // write pre-init user code here
            screenCommand1 = new Command("SAVE", "Save data", Command.SCREEN, 0);//GEN-LINE:|56-getter|1|56-postInit
            // write post-init user code here
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: fileBrowser ">//GEN-BEGIN:|75-getter|0|75-preInit
    /**
     * Returns an initiliazed instance of fileBrowser component.
     * @return the initialized component instance
     */
    public FileBrowser getFileBrowser() {
        if (fileBrowser == null) {//GEN-END:|75-getter|0|75-preInit
            // write pre-init user code here
            fileBrowser = new FileBrowser(getDisplay());//GEN-BEGIN:|75-getter|1|75-postInit
            fileBrowser.setTitle("fileBrowser");
            fileBrowser.setCommandListener(this);
            fileBrowser.addCommand(FileBrowser.SELECT_FILE_COMMAND);//GEN-END:|75-getter|1|75-postInit
            // write post-init user code here
...
//</editor-fold>//GEN-END:|75-getter|2|
    ...
    public void saveData(){
        try {
            fileName = "file://C//timer.txt";
            conn = (StreamConnection) Connector.open(fileName);
        } catch (IOException e){
