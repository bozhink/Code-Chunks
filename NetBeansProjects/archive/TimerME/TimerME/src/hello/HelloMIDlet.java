...
//</editor-fold>//GEN-END:|fields|0|
    ...
    public void PrintCurrentTime()
    {
        ...
        //OldTime=CurrentTime;
        data = this.textField.getString()+Long.toString(CurrentTime)+"\n";
        if (data.length()<=textField.getMaxSize())
        {
            this.textField.setString(data);
        }
        else
        {
...
//GEN-LINE:|7-commandAction|12|41-postAction
            ...
            if (command == SplashScreen.DISMISS_COMMAND) {//GEN-END:|7-commandAction|13|50-preAction
                // write pre-action user code here
                switchDisplayable(null, getForm1());//GEN-LINE:|7-commandAction|14|50-postAction
                // write post-action user code here
            }//GEN-BEGIN:|7-commandAction|15|7-postCommandAction
        }//GEN-END:|7-commandAction|15|7-postCommandAction
        // write post-action user code here
    }//GEN-BEGIN:|7-commandAction|16|59-postAction
//</editor-fold>//GEN-END:|7-commandAction|16|59-postAction
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: form1 ">//GEN-BEGIN:|29-getter|0|29-preInit
    ...
    public Form getForm1() {
        if (form1 == null) {//GEN-END:|29-getter|0|29-preInit
            // write pre-init user code here
            form1 = new Form("Timer", new Item[]{getTextField()});//GEN-BEGIN:|29-getter|1|29-postInit
...
//<editor-fold defaultstate="collapsed" desc=" Generated Getter: textField ">//GEN-BEGIN:|30-getter|0|30-preInit
    ...
    public TextField getTextField() {
        if (textField == null) {//GEN-END:|30-getter|0|30-preInit
            // write pre-init user code here
            textField = new TextField("Timer", null, 32, TextField.ANY);//GEN-LINE:|30-getter|1|30-postInit
            // write post-init user code here
