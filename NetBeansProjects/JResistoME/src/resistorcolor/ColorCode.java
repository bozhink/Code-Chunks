...
public class ColorCode 
{
    ...
    public ColorCode(String Name, int Value, int Exponent, String Tolerance)
    {
        name = Name;
        value = Value;
        exponent = Exponent;
    ...
    public static ColorCode GOLD   = new ColorCode("GOLD",0,-1," ± 5 % (J)");
    public static ColorCode SILVER = new ColorCode("SILVER",0,-2," ± 10 % (K)");
    public static ColorCode NONE   = new ColorCode("",0," ± 20 %");
}
