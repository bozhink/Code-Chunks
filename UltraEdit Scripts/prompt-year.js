...
//Get user input
var pattern = "/([1-2][6-90][0-9][0-9])[^0-9]/gm";
var findStr;
var x = 0;
var lineNum;
...
while (!(UltraEdit.activeDocument.isEof())) {
    if (UltraEdit.activeDocument.isFound()) {
        ...
        /*
          If configuration setting >Home Key Always Goto Column 1< is
          not enabled, the cursor could be not at start of the line, if
          the line starts with spaces or tabs.
         */
